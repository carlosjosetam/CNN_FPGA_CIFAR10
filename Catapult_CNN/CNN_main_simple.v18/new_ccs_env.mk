ifeq "$(CXX_HOME)" ""
CXX_HOME                                      := /softl3/catapultc10_1b/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                      := gcc
...
ifeq "$(ModelSim_Path)" ""
ModelSim_Path                                 := /softslin/modelsim10_5c/modeltech/bin
...
OSCI_SYSTEMC_INCLUDE                          := /softl3/catapultc10_1b/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                              := /softl3/catapultc10_1b/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
ifeq "$(Visualizer_Exe)" ""
Visualizer_Exe                                := $(VISUALIZER_HOME)/bin/vis
export Visualizer_Exe
endif
ifeq "$(Visualizer_QuestaSimBin)" ""
Visualizer_QuestaSimBin                       := $(QUESTASIM_HOME)/bin
export Visualizer_QuestaSimBin
endif
ifeq "$(Visualizer_SharedLibrary)" ""
Visualizer_SharedLibrary                      := $(CATAPULT_VISUALIZER_SLIB)
export Visualizer_SharedLibrary
endif
ifeq "$(Visualizer_BinFile)" ""
Visualizer_BinFile                            := visualizer.bin
export Visualizer_BinFile
endif
ifeq "$(Visualizer_UseFullVisualizer)" ""
Visualizer_UseFullVisualizer                  := false
export Visualizer_UseFullVisualizer
endif
ifeq "$(Visualizer_lddDebug)" ""
Visualizer_lddDebug                           := false
export Visualizer_lddDebug
endif
...
ifeq "$(Precision_Path)" ""
Precision_Path                                := /softslin/precision2016_1_1/Mgc_home/bin
...
Vivado_XILINX_VIVADO                          := /softslin/vivado_17.1/Vivado/2017.1
...
ifeq "$(Vivado_COMPXLIB_DIR)" ""
Vivado_COMPXLIB_DIR                           := 
export Vivado_COMPXLIB_DIR
endif
...
ifeq "$(MODEL_TECH)" ""
MODEL_TECH                                    := /softslin/modelsim10_5c/modeltech/bin
export MODEL_TECH
endif
ifeq "$(INCL_DIRS)" ""
INCL_DIRS                                     := 
