...
# Clocks #
##########
create_clock [get_ports clk] -name clk -domain xmplr_ClockDomain_clk -period 40 -waveform {0 20} -constraint_source user
create_clock  -name virtual_io_clk -domain xmplr_ClockDomain_clk -period 40 -waveform {0 20} -constraint_source user
