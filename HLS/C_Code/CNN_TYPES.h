...
typedef ac_fixed<PIXEL_WIDTH,PIXEL_WIDTH,true,AC_TRN,AC_SAT> pixel_type ;
typedef ac_fixed<ADDRESS_WIDTH,ADDRESS_WIDTH,true,AC_TRN,AC_SAT> address_type;
typedef ac_fixed<INDEX_WIDTH,INDEX_WIDTH,true,AC_TRN,AC_SAT> index_type;
