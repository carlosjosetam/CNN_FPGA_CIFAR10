...
//  
//  Running on Linux smancini@ocaepc47 3.16.0-4-amd64 x86_64 aol
//  
...
solution options set /Input/SearchPath {/tima/smancini/soft/TPU/tpu_no_DCM_PE/tpu_no_DCM_PE /tima/smancini/soft/TPU/setup /tima/smancini/soft/TPU/tpu_lib_DCM /tima/smancini/soft/TPU/test_2D_PE}
solution options set /TextEditor/FontSize 10
solution file add ./ImgProcTest.cpp -type C++
...
go compile
solution library add mgc_Xilinx-ARTIX-7-1_beh -- -rtlsyntool Precision -manufacturer Xilinx -family ARTIX-7 -speed -1 -part xc7a50tcsg324-1
