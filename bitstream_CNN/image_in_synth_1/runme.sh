...
HD_PWD='/tp-fmr/xph3sei710_Tamancoldi_Silveira/Vivado/CNN_CIFAR10/bitstream/image_in_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_in.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_in.tcl
